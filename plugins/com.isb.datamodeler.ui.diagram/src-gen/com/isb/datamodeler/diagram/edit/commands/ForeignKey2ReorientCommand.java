 ...
 * @generated
 */
public class ForeignKey2ReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ForeignKey2ReorientCommand(ReorientRelationshipRequest request) {
	...
	protected boolean canReorientSource() {
		...
		return DatamodelerBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistForeignKey_4002(getLink(), getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		return DatamodelerBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistForeignKey_4002(getLink(), source, getNewTarget());
	}
