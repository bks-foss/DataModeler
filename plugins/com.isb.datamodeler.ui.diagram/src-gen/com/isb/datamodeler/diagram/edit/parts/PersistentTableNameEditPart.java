 ...
 * @generated
 */
public class PersistentTableNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
			...
			parser = DatamodelerParserProvider
					.getParser(
							...
							DatamodelerVisualIDRegistry
									.getType(com.isb.datamodeler.diagram.edit.parts.PersistentTableNameEditPart.VISUAL_ID));
		}
		return parser;
	}
