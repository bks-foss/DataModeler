...
import com.isb.datamodeler.diagram.edit.policies.ColumnItemSemanticEditPolicy;
...
public class ColumnEditPart extends CompartmentEditPart implements
	...
	protected void setLabelTextHelper(IFigure figure, String text) {
		...
		if (getNotationView().getEAnnotation("ShortLabelDecorator") != null) { //$NON-NLS-1$
			...
			parser = DatamodelerParserProvider
					.getParser(
							...
							DatamodelerVisualIDRegistry
									.getType(com.isb.datamodeler.diagram.edit.parts.ColumnEditPart.VISUAL_ID));
		}
		return parser;
	}
	 ...
	 * @generated
	 */
	public class ColumnFigure extends WrappingLabel {
