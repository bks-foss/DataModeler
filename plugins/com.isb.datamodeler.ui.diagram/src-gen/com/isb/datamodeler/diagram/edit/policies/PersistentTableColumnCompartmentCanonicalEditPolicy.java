 ...
 * @generated
 */
public class PersistentTableColumnCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return ETablesPackage.eINSTANCE.getTable_Columns();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<DatamodelerNodeDescriptor> childDescriptors = DatamodelerDiagramUpdater
				.getPersistentTableColumnCompartment_7001SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return ColumnEditPart.VISUAL_ID == DatamodelerVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<DatamodelerNodeDescriptor> childDescriptors = DatamodelerDiagramUpdater
				.getPersistentTableColumnCompartment_7001SemanticChildren((View) getHost()
						.getModel());
