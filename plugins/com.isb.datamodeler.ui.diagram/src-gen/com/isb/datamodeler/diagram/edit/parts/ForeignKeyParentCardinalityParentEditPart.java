 ...
 * @generated
 */
public class ForeignKeyParentCardinalityParentEditPart extends LabelEditPart
	...
	static {
		registerSnapBackPosition(
				DatamodelerVisualIDRegistry
						.getType(com.isb.datamodeler.diagram.edit.parts.ForeignKeyParentCardinalityParentEditPart.VISUAL_ID),
				new Point(0, 80));
	}
	 ...
	 * @generated
	 */
	public ForeignKeyParentCardinalityParentEditPart(View view) {
		super(view);
	}
		...
		if (parserElement != null && getParser() != null) {
			text = getParser().getPrintString(
					new org.eclipse.gmf.runtime.emf.core.util.EObjectAdapter(
							parserElement), getParserOptions().intValue());
		}
