 ...
 * @generated
 */
public class DatamodelerValidationDecoratorProvider extends AbstractProvider
	 ...
	 * @generated
	 */
	private static final String MARKER_TYPE = DatamodelerDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof DatamodelerDiagramEditor) {
	...
	public boolean provides(IOperation operation) {
		...
		return view != null
				&& SchemaEditPart.MODEL_ID.equals(DatamodelerVisualIDRegistry
						.getModelID(view));
	}
