 ...
 * @generated
 */
public class DatamodelerInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new DatamodelerNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				SchemaEditPart.MODEL_ID));
		DatamodelerDiagramEditorUtil.runWizard(getShell(), wizard,
