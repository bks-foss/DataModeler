 ...
 * @generated
 */
public class DatamodelerElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public DatamodelerElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell()
				.setText(
						Messages.DatamodelerElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "Datamodeler".equals(fileExtension); //$NON-NLS-1$
	}
