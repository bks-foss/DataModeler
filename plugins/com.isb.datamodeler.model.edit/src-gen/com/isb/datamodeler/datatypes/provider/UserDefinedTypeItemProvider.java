 ...
 * </copyright>
 *
 * $Id: UserDefinedTypeItemProvider.java,v 1.7 2011/08/12 09:53:19 aalvamat Exp $
 */
...
import com.isb.datamodeler.datatypes.EUserDefinedType;
import com.isb.datamodeler.provider.IItemPropertyDescriptorProvider;

/**
 * This is the item provider adapter for a {@link com.isb.datamodeler.datatypes.EUserDefinedType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UserDefinedTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EDatatypesPackage.Literals.USER_DEFINED_TYPE__SCHEMA,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EDatatypesPackage.Literals.USER_DEFINED_TYPE__ORDERING);
		}
	...
	public String getText(Object object) {
		String label = ((EUserDefinedType)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EUserDefinedType.class)) {
			case EDatatypesPackage.USER_DEFINED_TYPE__ORDERING:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EDatatypesPackage.Literals.USER_DEFINED_TYPE__ORDERING,
				 EDatatypesFactory.eINSTANCE.createUserDefinedTypeOrdering()));
	}
