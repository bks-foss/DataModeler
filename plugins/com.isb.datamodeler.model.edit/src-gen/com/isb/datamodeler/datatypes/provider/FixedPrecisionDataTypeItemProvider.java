...
/**
 * This is the item provider adapter for a {@link com.isb.datamodeler.datatypes.EFixedPrecisionDataType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FixedPrecisionDataTypeItemProvider
	...
	public String getText(Object object) {
		String label = ((EFixedPrecisionDataType)object).getName();
		if(label == null || label.length() == 0)
			return getString("_UI_FixedPrecisionDataType_type");
		
		label = label + "(" + ((EFixedPrecisionDataType)object).getPrecision() + "," +  
		  						((EFixedPrecisionDataType)object).getScale() + ")";
		return label;
	}
