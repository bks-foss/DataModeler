 ...
 * </copyright>
 *
 * $Id: ArrayDataTypeItemProvider.java,v 1.7 2011/08/12 09:53:19 aalvamat Exp $
 */
...
import com.isb.datamodeler.datatypes.EArrayDataType;
...
/**
 * This is the item provider adapter for a {@link com.isb.datamodeler.datatypes.EArrayDataType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArrayDataTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EDatatypesPackage.Literals.ARRAY_DATA_TYPE__MAX_CARDINALITY,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((EArrayDataType)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EArrayDataType.class)) {
			case EDatatypesPackage.ARRAY_DATA_TYPE__MAX_CARDINALITY:
