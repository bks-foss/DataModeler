 ...
 * </copyright>
 *
 * $Id: PrimitiveDataTypeItemProvider.java,v 1.2 2011/08/12 09:53:19 aalvamat Exp $
 */
...
/**
 * This is the item provider adapter for a {@link com.isb.datamodeler.datatypes.EPrimitiveDataType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PrimitiveDataTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PrimitiveDataType_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PrimitiveDataType_value_feature", "_UI_PrimitiveDataType_type"),
				 EDatatypesPackage.Literals.PRIMITIVE_DATA_TYPE__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((EPrimitiveDataType)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EPrimitiveDataType.class)) {
			case EDatatypesPackage.PRIMITIVE_DATA_TYPE__VALUE:
