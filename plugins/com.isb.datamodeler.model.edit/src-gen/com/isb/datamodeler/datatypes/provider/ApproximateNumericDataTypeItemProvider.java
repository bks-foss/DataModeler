...
/**
 * This is the item provider adapter for a {@link com.isb.datamodeler.datatypes.EApproximateNumericDataType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ApproximateNumericDataTypeItemProvider
	...
	public String getText(Object object) {
		String label = ((EApproximateNumericDataType)object).getName();
		
		if(label == null || label.length() == 0)
			return getString("_UI_ApproximateNumericDataType_type");

		label = label + "(" + ((EApproximateNumericDataType)object).getPrecision() + ")";
