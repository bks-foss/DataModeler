...
/**
 * This is the item provider adapter for a {@link com.isb.datamodeler.datatypes.ECharacterStringDataType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CharacterStringDataTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EDatatypesPackage.Literals.CHARACTER_STRING_DATA_TYPE__LENGTH,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((ECharacterStringDataType)object).getName();
		if(label == null || label.length() == 0)
			return getString("_UI_CharacterStringDataType_type");

		label = label + "(" + ((ECharacterStringDataType)object).getLength() + ")";
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ECharacterStringDataType.class)) {
			case EDatatypesPackage.CHARACTER_STRING_DATA_TYPE__LENGTH:
			case EDatatypesPackage.CHARACTER_STRING_DATA_TYPE__FIXED_LENGTH:
			case EDatatypesPackage.CHARACTER_STRING_DATA_TYPE__COLLATION_NAME:
			case EDatatypesPackage.CHARACTER_STRING_DATA_TYPE__COERCIBILITY:
