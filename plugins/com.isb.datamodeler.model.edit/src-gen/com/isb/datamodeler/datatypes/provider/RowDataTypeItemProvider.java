 ...
 * </copyright>
 *
 * $Id: RowDataTypeItemProvider.java,v 1.7 2011/08/12 09:53:19 aalvamat Exp $
 */
...
import com.isb.datamodeler.datatypes.ERowDataType;
import com.isb.datamodeler.provider.IItemPropertyDescriptorProvider;

/**
 * This is the item provider adapter for a {@link com.isb.datamodeler.datatypes.ERowDataType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RowDataTypeItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EDatatypesPackage.Literals.ROW_DATA_TYPE__FIELDS);
		}
	...
	public String getText(Object object) {
		String label = ((ERowDataType)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ERowDataType.class)) {
			case EDatatypesPackage.ROW_DATA_TYPE__FIELDS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EDatatypesPackage.Literals.ROW_DATA_TYPE__FIELDS,
				 EDatatypesFactory.eINSTANCE.createField()));
	}
