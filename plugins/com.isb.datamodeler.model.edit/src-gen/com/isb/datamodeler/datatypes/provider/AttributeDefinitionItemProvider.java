 ...
 * </copyright>
 *
 * $Id: AttributeDefinitionItemProvider.java,v 1.7 2011/08/12 09:53:19 aalvamat Exp $
 */
...
import com.isb.datamodeler.datatypes.EAttributeDefinition;
...
/**
 * This is the item provider adapter for a {@link com.isb.datamodeler.datatypes.EAttributeDefinition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AttributeDefinitionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EDatatypesPackage.Literals.ATTRIBUTE_DEFINITION__SCOPE_CHECK,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EDatatypesPackage.Literals.ATTRIBUTE_DEFINITION__SCOPE_CHECKED,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EDatatypesPackage.Literals.ATTRIBUTE_DEFINITION__DEFAULT_VALUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((EAttributeDefinition)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EAttributeDefinition.class)) {
			case EDatatypesPackage.ATTRIBUTE_DEFINITION__SCOPE_CHECK:
			case EDatatypesPackage.ATTRIBUTE_DEFINITION__SCOPE_CHECKED:
			case EDatatypesPackage.ATTRIBUTE_DEFINITION__DEFAULT_VALUE:
