 ...
 * </copyright>
 *
 * $Id: CharacterSetItemProvider.java,v 1.7 2011/08/12 09:53:19 aalvamat Exp $
 */
...
import com.isb.datamodeler.datatypes.ECharacterSet;
...
/**
 * This is the item provider adapter for a {@link com.isb.datamodeler.datatypes.ECharacterSet} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CharacterSetItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EDatatypesPackage.Literals.CHARACTER_SET__DEFAULT_COLLATION,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EDatatypesPackage.Literals.CHARACTER_SET__ENCODING,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EDatatypesPackage.Literals.CHARACTER_SET__CHARACTER_STRING_DATA_TYPE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EDatatypesPackage.Literals.CHARACTER_SET__SCHEMA,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EDatatypesPackage.Literals.CHARACTER_SET__REPERTOIRE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((ECharacterSet)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ECharacterSet.class)) {
			case EDatatypesPackage.CHARACTER_SET__DEFAULT_COLLATION:
			case EDatatypesPackage.CHARACTER_SET__ENCODING:
			case EDatatypesPackage.CHARACTER_SET__REPERTOIRE:
