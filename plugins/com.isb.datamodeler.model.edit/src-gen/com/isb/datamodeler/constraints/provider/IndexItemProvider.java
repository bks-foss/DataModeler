 ...
 * </copyright>
 *
 * $Id: IndexItemProvider.java,v 1.7 2011/08/12 09:53:18 aalvamat Exp $
 */
...
import com.isb.datamodeler.constraints.EIndex;
...
/**
 * This is the item provider adapter for a {@link com.isb.datamodeler.constraints.EIndex} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IndexItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EConstraintsPackage.Literals.INDEX__SCHEMA,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EConstraintsPackage.Literals.INDEX__CLUSTERED,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EConstraintsPackage.Literals.INDEX__FILL_FACTOR,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EConstraintsPackage.Literals.INDEX__UNIQUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EConstraintsPackage.Literals.INDEX__SYSTEM_GENERATED,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EConstraintsPackage.Literals.INDEX__TABLE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addForeignKeyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Index_ForeignKey_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Index_ForeignKey_feature", "_UI_Index_type"),
				 EConstraintsPackage.Literals.INDEX__FOREIGN_KEY,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EConstraintsPackage.Literals.INDEX__MEMBERS);
			childrenFeatures.add(EConstraintsPackage.Literals.INDEX__INCLUDED_MEMBERS);
		}
	...
	public String getText(Object object) {
		String label = ((EIndex)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EIndex.class)) {
			case EConstraintsPackage.INDEX__CLUSTERED:
			case EConstraintsPackage.INDEX__FILL_FACTOR:
			case EConstraintsPackage.INDEX__UNIQUE:
			case EConstraintsPackage.INDEX__SYSTEM_GENERATED:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case EConstraintsPackage.INDEX__MEMBERS:
			case EConstraintsPackage.INDEX__INCLUDED_MEMBERS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EConstraintsPackage.Literals.INDEX__MEMBERS,
				 EConstraintsFactory.eINSTANCE.createIndexMember()));

		newChildDescriptors.add
			(createChildParameter
				(EConstraintsPackage.Literals.INDEX__INCLUDED_MEMBERS,
				 EConstraintsFactory.eINSTANCE.createIndexMember()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == EConstraintsPackage.Literals.INDEX__MEMBERS ||
			childFeature == EConstraintsPackage.Literals.INDEX__INCLUDED_MEMBERS;
