 ...
 * </copyright>
 *
 * $Id: CheckConstraintItemProvider.java,v 1.7 2011/08/12 09:53:18 aalvamat Exp $
 */
...
import com.isb.datamodeler.constraints.ECheckConstraint;
...
/**
 * This is the item provider adapter for a {@link com.isb.datamodeler.constraints.ECheckConstraint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CheckConstraintItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EConstraintsPackage.Literals.CHECK_CONSTRAINT__SEARCH_CONDITION);
		}
	...
	public String getText(Object object) {
		String label = ((ECheckConstraint)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ECheckConstraint.class)) {
			case EConstraintsPackage.CHECK_CONSTRAINT__SEARCH_CONDITION:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EConstraintsPackage.Literals.CHECK_CONSTRAINT__SEARCH_CONDITION,
