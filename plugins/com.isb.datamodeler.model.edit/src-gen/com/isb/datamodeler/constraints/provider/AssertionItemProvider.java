 ...
 * </copyright>
 *
 * $Id: AssertionItemProvider.java,v 1.7 2011/08/12 09:53:18 aalvamat Exp $
 */
...
import com.isb.datamodeler.constraints.EAssertion;
...
/**
 * This is the item provider adapter for a {@link com.isb.datamodeler.constraints.EAssertion} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AssertionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EConstraintsPackage.Literals.ASSERTION__SCHEMA,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EConstraintsPackage.Literals.ASSERTION__CONSTRAINED_TABLES,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EConstraintsPackage.Literals.ASSERTION__SEARCH_CONDITION);
		}
	...
	public String getText(Object object) {
		String label = ((EAssertion)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EAssertion.class)) {
			case EConstraintsPackage.ASSERTION__SEARCH_CONDITION:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EConstraintsPackage.Literals.ASSERTION__SEARCH_CONDITION,
