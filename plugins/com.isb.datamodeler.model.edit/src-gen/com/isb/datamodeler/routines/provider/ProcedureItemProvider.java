 ...
 * </copyright>
 *
 * $Id: ProcedureItemProvider.java,v 1.7 2011/08/12 09:53:18 aalvamat Exp $
 */
...
import com.isb.datamodeler.routines.EProcedure;
import com.isb.datamodeler.routines.ERoutinesFactory;
import com.isb.datamodeler.routines.ERoutinesPackage;

/**
 * This is the item provider adapter for a {@link com.isb.datamodeler.routines.EProcedure} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProcedureItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ERoutinesPackage.Literals.PROCEDURE__MAX_RESULT_SETS,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ERoutinesPackage.Literals.PROCEDURE__OLD_SAVE_POINT,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ERoutinesPackage.Literals.PROCEDURE__RESULT_SET);
		}
	...
	public String getText(Object object) {
		String label = ((EProcedure)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EProcedure.class)) {
			case ERoutinesPackage.PROCEDURE__MAX_RESULT_SETS:
			case ERoutinesPackage.PROCEDURE__OLD_SAVE_POINT:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case ERoutinesPackage.PROCEDURE__RESULT_SET:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ERoutinesPackage.Literals.PROCEDURE__RESULT_SET,
