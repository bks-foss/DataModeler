 ...
 * </copyright>
 *
 * $Id: EventItemProvider.java,v 1.7 2011/08/12 09:53:19 aalvamat Exp $
 */
...
/**
 * This is the item provider adapter for a {@link com.isb.datamodeler.schema.EEvent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EventItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ESchemaPackage.Literals.EVENT__FOR,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ESchemaPackage.Literals.EVENT__CONDITION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ESchemaPackage.Literals.EVENT__ACTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ESchemaPackage.Literals.EVENT__ENABLED,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ESchemaPackage.Literals.EVENT__DATABASE,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((EEvent)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EEvent.class)) {
			case ESchemaPackage.EVENT__FOR:
			case ESchemaPackage.EVENT__CONDITION:
			case ESchemaPackage.EVENT__ACTION:
			case ESchemaPackage.EVENT__ENABLED:
