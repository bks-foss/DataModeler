 ...
 * </copyright>
 *
 * $Id: CommentItemProvider.java,v 1.7 2011/08/12 09:53:19 aalvamat Exp $
 */
...
import com.isb.datamodeler.schema.EComment;
import com.isb.datamodeler.schema.ESchemaPackage;

/**
 * This is the item provider adapter for a {@link com.isb.datamodeler.schema.EComment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CommentItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ESchemaPackage.Literals.COMMENT__DESCRIPTION,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ESchemaPackage.Literals.COMMENT__SQL_OBJECT,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((EComment)object).getDescription();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EComment.class)) {
			case ESchemaPackage.COMMENT__DESCRIPTION:
