 ...
 * </copyright>
 *
 * $Id: SchemaItemProvider.java,v 1.22 2012/06/05 11:10:12 aalvamat Exp $
 */
...
/**
 * This is the item provider adapter for a {@link com.isb.datamodeler.schema.ESchema} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SchemaItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ESchemaPackage.Literals.SCHEMA__DATABASE,
				 false,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ESchemaPackage.Literals.SCHEMA__DESCRIPTION,
				 true,
				 true,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ESchemaPackage.Literals.SCHEMA__TABLES);
		}
	...
	public String getText(Object object) {
		String label = ((ESchema)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ESchema.class)) {
			case ESchemaPackage.SCHEMA__CAPABILITY:
			case ESchemaPackage.SCHEMA__DESCRIPTION:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case ESchemaPackage.SCHEMA__TABLES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		// Comentados porque sólo queremos crear Persitent Tables
		/*newChildDescriptors.add
			(createChildParameter
				(ESchemaPackage.Literals.SCHEMA__TABLES,
				 ERoutinesFactory.eINSTANCE.createRoutineResultTable()));

		newChildDescriptors.add
			(createChildParameter
				(ESchemaPackage.Literals.SCHEMA__TABLES,
				 ETablesFactory.eINSTANCE.createViewTable()));

		newChildDescriptors.add
			(createChildParameter
				(ESchemaPackage.Literals.SCHEMA__TABLES,
				 ETablesFactory.eINSTANCE.createTemporaryTable()));*/

		newChildDescriptors.add
			(createChildParameter
				(ESchemaPackage.Literals.SCHEMA__TABLES,
				 ETablesFactory.eINSTANCE.createPersistentTable()));
	}
