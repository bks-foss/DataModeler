 ...
 * </copyright>
 *
 * $Id: SequenceItemProvider.java,v 1.7 2011/08/12 09:53:19 aalvamat Exp $
 */
...
import com.isb.datamodeler.schema.ESequence;

/**
 * This is the item provider adapter for a {@link com.isb.datamodeler.schema.ESequence} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SequenceItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ESchemaPackage.Literals.SEQUENCE__SCHEMA,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ESchemaPackage.Literals.SEQUENCE__IDENTITY);
		}
	...
	public String getText(Object object) {
		String label = ((ESequence)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ESequence.class)) {
			case ESchemaPackage.SEQUENCE__IDENTITY:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ESchemaPackage.Literals.SEQUENCE__IDENTITY,
				 ESchemaFactory.eINSTANCE.createIdentitySpecifier()));
	}
