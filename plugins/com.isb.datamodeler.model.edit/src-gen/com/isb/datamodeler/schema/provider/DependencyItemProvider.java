 ...
 * </copyright>
 *
 * $Id: DependencyItemProvider.java,v 1.7 2011/08/12 09:53:19 aalvamat Exp $
 */
...
import com.isb.datamodeler.schema.EDependency;
import com.isb.datamodeler.schema.ESchemaPackage;

/**
 * This is the item provider adapter for a {@link com.isb.datamodeler.schema.EDependency} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DependencyItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ESchemaPackage.Literals.DEPENDENCY__TARGET_END,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ESchemaPackage.Literals.DEPENDENCY__DEPENDENCY_TYPE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((EDependency)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EDependency.class)) {
			case ESchemaPackage.DEPENDENCY__DEPENDENCY_TYPE:
