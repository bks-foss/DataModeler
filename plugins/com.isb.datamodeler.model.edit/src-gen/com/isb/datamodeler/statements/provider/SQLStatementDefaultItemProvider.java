 ...
 * </copyright>
 *
 * $Id: SQLStatementDefaultItemProvider.java,v 1.7 2011/08/12 09:53:19 aalvamat Exp $
 */
package com.isb.datamodeler.statements.provider;
...
import com.isb.datamodeler.statements.ESQLStatementDefault;
import com.isb.datamodeler.statements.EStatementsPackage;

/**
 * This is the item provider adapter for a {@link com.isb.datamodeler.statements.ESQLStatementDefault} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SQLStatementDefaultItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EStatementsPackage.Literals.SQL_STATEMENT_DEFAULT__SQL,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((ESQLStatementDefault)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ESQLStatementDefault.class)) {
			case EStatementsPackage.SQL_STATEMENT_DEFAULT__SQL:
