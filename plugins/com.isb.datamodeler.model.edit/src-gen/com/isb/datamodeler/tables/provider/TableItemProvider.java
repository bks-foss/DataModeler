 ...
 * </copyright>
 *
 * $Id: TableItemProvider.java,v 1.15 2012/01/20 14:01:53 dsalmero Exp $
 */
...
/**
 * This is the item provider adapter for a {@link com.isb.datamodeler.tables.ETable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TableItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ETablesPackage.Literals.TABLE__COLUMNS,
				 true,
				 false,
				 false,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ETablesPackage.Literals.TABLE__SCHEMA,
				 false,
				 false,
				 true,
				 null,
	...
	protected void addPrefixPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Table_prefix_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Table_prefix_feature", "_UI_Table_type"),
				 ETablesPackage.Literals.TABLE__PREFIX,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ETablesPackage.Literals.TABLE__DESCRIPTION,
				 true,
				 true,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ETablesPackage.Literals.TABLE__COLUMNS);
		}
	...
	public String getText(Object object) {
		String label = ((ETable)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ETable.class)) {
			case ETablesPackage.TABLE__SELF_REF_COLUMN_GENERATION:
			case ETablesPackage.TABLE__INSERTABLE:
			case ETablesPackage.TABLE__UPDATABLE:
			case ETablesPackage.TABLE__PREFIX:
			case ETablesPackage.TABLE__DESCRIPTION:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case ETablesPackage.TABLE__COLUMNS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ETablesPackage.Literals.TABLE__COLUMNS,
				 ETablesFactory.eINSTANCE.createColumn()));
	}
