 ...
 * </copyright>
 *
 * $Id: TemporaryTableItemProvider.java,v 1.9 2011/08/12 09:53:19 aalvamat Exp $
 */
...
import com.isb.datamodeler.tables.ETemporaryTable;

/**
 * This is the item provider adapter for a {@link com.isb.datamodeler.tables.ETemporaryTable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TemporaryTableItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ETablesPackage.Literals.TEMPORARY_TABLE__LOCAL,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ETablesPackage.Literals.TEMPORARY_TABLE__DELETE_ON_COMMIT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((ETemporaryTable)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ETemporaryTable.class)) {
			case ETablesPackage.TEMPORARY_TABLE__LOCAL:
			case ETablesPackage.TEMPORARY_TABLE__DELETE_ON_COMMIT:
