 ...
 * </copyright>
 *
 * $Id: DerivedTableItemProvider.java,v 1.8 2011/08/12 09:53:19 aalvamat Exp $
 */
...
import com.isb.datamodeler.tables.EDerivedTable;
import com.isb.datamodeler.tables.ETablesPackage;

/**
 * This is the item provider adapter for a {@link com.isb.datamodeler.tables.EDerivedTable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DerivedTableItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ETablesPackage.Literals.DERIVED_TABLE__QUERY_EXPRESSION);
		}
	...
	public String getText(Object object) {
		String label = ((EDerivedTable)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EDerivedTable.class)) {
			case ETablesPackage.DERIVED_TABLE__QUERY_EXPRESSION:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ETablesPackage.Literals.DERIVED_TABLE__QUERY_EXPRESSION,
				 EExpressionsFactory.eINSTANCE.createQueryExpressionDefault()));
	}
