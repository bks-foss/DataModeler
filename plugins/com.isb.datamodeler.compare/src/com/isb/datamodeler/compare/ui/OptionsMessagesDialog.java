...
public class OptionsMessagesDialog extends MessageDialog {
	...
	public OptionsMessagesDialog(Shell parentShell, String dialogTitle,
			String message,
			String[] optionLabels,
			int[] optionValues,
			int defaultOption) {
		
		super(parentShell, dialogTitle, null, message, WARNING,
