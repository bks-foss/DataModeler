...
/**
 * 
 * El modelcompareInput es la clase que se encarga de guardar la información
 * sobre el modelo de diferencias y el macheo, cuando se realiza un merge
 * se modifica este objeto, el problema es que por nuestro diseño para filtrar elementos, 
 * necesitamos actualizarlo, y como no dejaba usabamos dos instancias diferentes
 * y por tanto existían problemas de sincronización para refrescar los editores y las diferencias
 * 
 */
public class DataModelCompareInput extends ModelCompareInput {
	 ...
	 */
	public DataModelCompareInput(MatchModel matchModel, DiffModel diffModel) {
	 ...
	 */
	public DataModelCompareInput(MatchResourceSet matchResourceset, DiffResourceSet diffResourceSet) {
	 ...
	 * {@link DataModelCompareInput input} that a change occured.
	 */
