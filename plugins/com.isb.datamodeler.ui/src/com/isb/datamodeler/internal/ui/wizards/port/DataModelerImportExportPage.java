...
public abstract class DataModelerImportExportPage extends
		DataModelerPortWizardSelectionPage {
	...
	protected class CategorizedWizardSelectionTree {
		...
		private void createFilteredTree(Composite parent){        
	        ...
	        viewer.setContentProvider(new DataModelerPortWizardContentProvider());
	 ...
	 */
	protected DataModelerImportExportPage(IWorkbench aWorkbench, IStructuredSelection currentSelection){
    ...
    protected void treeDoubleClicked(DoubleClickEvent event){
		...
		} else if (element instanceof DataModelerPortWizardElement) {
     ...
     */
    private void updateSelectedNode(DataModelerPortWizardElement wizardElement){
    ...
    protected void updateMessage(){
    	...
    	if (viewer != null){
            ...
            if (sel instanceof DataModelerPortWizardElement){
               	updateSelectedNode((DataModelerPortWizardElement)sel);
            }
            else{
            	setSelectedNode(null);
            }
    ...
    protected void listSelectionChanged(ISelection selection){
        ...
        Object sel = ss.getFirstElement();
        if (sel instanceof DataModelerPortWizardElement){
        	DataModelerPortWizardElement currentWizardSelection = (DataModelerPortWizardElement) sel;        
	...
	private IWizardNode createWizardNode(IWizardDescriptor element) {
        return new DataModelerPortWizardNode(this, element) {
