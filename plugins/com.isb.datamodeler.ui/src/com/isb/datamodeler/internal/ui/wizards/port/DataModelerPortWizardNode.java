...
public abstract class DataModelerPortWizardNode implements IWizardNode, IPluginContribution {
	
	protected DataModelerPortWizardSelectionPage parentWizardPage;
	...
	*/
	public DataModelerPortWizardNode(DataModelerPortWizardSelectionPage aWizardPage,
	                ...
	                SafeRunner.run(new SafeRunnable() {
	                    ...
	                    public void handleException(Throwable e) {
	                        ...
	                        statuses[0] = new Status(
	                                IStatus.ERROR,
	                                contribution != null ? contribution.getPluginId() : DataModelerUI.PLUGIN_ID,
	                                IStatus.OK,
