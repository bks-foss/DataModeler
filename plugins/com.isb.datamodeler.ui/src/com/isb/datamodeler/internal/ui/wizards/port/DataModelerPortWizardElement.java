...
import com.isb.datamodeler.internal.registry.KeywordRegistry;
import com.isb.datamodeler.internal.registry.RegistryReader;

/**
 * Instances represent registered wizards.
 */
public class DataModelerPortWizardElement extends WorkbenchAdapter implements
	...
	private DataModelerPortWizardCollectionElement parentCategory;
	...
	* @since 3.1
	*/
	public DataModelerPortWizardElement(IConfigurationElement configurationElement) {
		this.configurationElement = configurationElement;
		id = configurationElement.getAttribute(IDataModelerUIRegistryConstants.ATT_ID);
	}
	...
	*/
	...
	return WorkbenchPlugin.createExtension(configurationElement,
			IDataModelerUIRegistryConstants.ATT_CLASS);
	}
	...
	*/
	...
	if (imageDescriptor == null) {
		String iconName = configurationElement
	            .getAttribute(IDataModelerUIRegistryConstants.ATT_ICON);
	    if (iconName == null) {
			return null;
		}
	...
	*/
	...
	return configurationElement.getAttribute(IDataModelerUIRegistryConstants.ATT_NAME);
	}
	...
	*/
	...
	if (descriptionImage == null) {
		String descImage = configurationElement.getAttribute(IDataModelerUIRegistryConstants.ATT_DESCRIPTION_IMAGE);
		if (descImage == null) {
			return null;
		}
	...
	*/
	...
	return configurationElement.getAttribute(IDataModelerUIRegistryConstants.ATT_HELP_HREF);
	}
	...
	* @since 3.1
	*/
	public DataModelerPortWizardCollectionElement getCollectionElement() {
	return (DataModelerPortWizardCollectionElement) getParent(this);
	}
	...
	*/
	...
	String flag = configurationElement.getAttribute(IDataModelerUIRegistryConstants.ATT_PROJECT);
	...
	* @since 3.1
	*/
	public void setParent(DataModelerPortWizardCollectionElement parent) {
	...
	*/
	...
	return Boolean.valueOf(configurationElement.getAttribute(IDataModelerUIRegistryConstants.ATT_CAN_FINISH_EARLY)).booleanValue();
	}
	...
	*/
	...
	String hasPagesString = configurationElement.getAttribute(IDataModelerUIRegistryConstants.ATT_HAS_PAGES);
