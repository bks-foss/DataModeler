...
public abstract class DataModelerPortWizardSelectionPage extends WizardSelectionPage {
     ...
     */
    public DataModelerPortWizardSelectionPage(String name, IWorkbench aWorkbench,
     ...
     */
    protected DataModelerPortWizardElement findWizard(String searchId) {
        Object[] children = wizardElements.getChildren();
        for (int i = 0; i < children.length; ++i) {
        	DataModelerPortWizardElement currentWizard = (DataModelerPortWizardElement) children[i];
