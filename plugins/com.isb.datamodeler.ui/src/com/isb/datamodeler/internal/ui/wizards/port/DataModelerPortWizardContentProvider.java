...
public class DataModelerPortWizardContentProvider implements ITreeContentProvider {
    ...
    public Object[] getChildren(Object parentElement) {
        if (parentElement instanceof DataModelerPortWizardCollectionElement) {
            ArrayList list = new ArrayList();
            DataModelerPortWizardCollectionElement element = (DataModelerPortWizardCollectionElement) parentElement;
            ...
            if (list.size() == 1
                    && list.get(0) instanceof DataModelerPortWizardCollectionElement) {
...
//            }
    ...
    public Object getParent(Object element) {
        if (element instanceof DataModelerPortWizardCollectionElement) {
            ...
            return ((DataModelerPortWizardCollectionElement) element).getParent(element);
        } 
        return null;
    }
