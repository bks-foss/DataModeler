...
public class IDataModelerUIRegistryConstants {
	/**
	 ...
	 */
	public static String EXTENSION_ACCELERATOR_CONFIGURATIONS = DataModelerUI.PLUGIN_ID
			+ '.' + PL_ACCELERATOR_CONFIGURATIONS;

	/**
	 * The name of the accelerator scopes extension point.
	 */
	public static String EXTENSION_ACCELERATOR_SCOPES = DataModelerUI.PLUGIN_ID
			+ '.' + PL_ACCELERATOR_SCOPES;

	/**
	 * The name of the action definitions extension point.
	 */
	public static String EXTENSION_ACTION_DEFINITIONS = DataModelerUI.PLUGIN_ID
			+ '.' + PL_ACTION_DEFINITIONS;

	/**
	 * The name of the <code>org.eclipse.ui.actionSets</code> extension point.
	 */
	public static String EXTENSION_ACTION_SETS = DataModelerUI.PLUGIN_ID
			+ '.' + IDataModelerUIRegistryConstants.PL_ACTION_SETS;

	/**
	 * The name of the bindings extension point.
	 */
	public static String EXTENSION_BINDINGS = DataModelerUI.PLUGIN_ID + '.'
			+ PL_BINDINGS;

	/**
	 * The name of the commands extension point.
	 */
	public static String EXTENSION_COMMAND_IMAGES = DataModelerUI.PLUGIN_ID
			+ '.' + PL_COMMAND_IMAGES;
	 ...
	 */
	public static String EXTENSION_COMMANDS = DataModelerUI.PLUGIN_ID + '.'
			+ PL_COMMANDS;

	/**
	 * The name of the contexts extension point.
	 */
	public static String EXTENSION_CONTEXTS = DataModelerUI.PLUGIN_ID + '.'
			+ PL_CONTEXTS;
	 ...
	 * point.
	 */
	public static String EXTENSION_EDITOR_ACTIONS = DataModelerUI.PLUGIN_ID
			+ '.' + PL_EDITOR_ACTIONS;

	/**
	 * The name of the commands extension point.
	 */
	public static String EXTENSION_HANDLERS = DataModelerUI.PLUGIN_ID + '.'
			+ PL_HANDLERS;

	/**
	 * The name of the <code>org.eclipse.ui.menus</code> extension point.
	 */
	public static String EXTENSION_MENUS = DataModelerUI.PLUGIN_ID + '.'
			+ PL_MENUS;

	/**
	 * The name of the <code>org.eclipse.ui.menus2</code> extension point.
	 */
	public static String COMMON_MENU_ADDITIONS = DataModelerUI.PLUGIN_ID + '.'
			+ PL_MENUS + '2';

	/**
	 * The name of the <code>org.eclipse.ui.popupMenus</code> extension point.
	 */
	public static String EXTENSION_POPUP_MENUS = DataModelerUI.PLUGIN_ID
			+ '.' + PL_POPUP_MENU;
	 ...
	 * point.
	 */
	public static String EXTENSION_VIEW_ACTIONS = DataModelerUI.PLUGIN_ID
			+ '.' + PL_VIEW_ACTIONS;
