...
public class Category implements IWorkbenchAdapter, IPluginContribution, IAdaptable {
     ...
     */
    public final static String MISC_NAME = Messages.bind("DataModelerImportAction.NewWizardsRegistryReader_otherCategory");
    ...
    public String getLabel() {
        return configurationElement == null ? name : configurationElement
				.getAttribute(IDataModelerUIRegistryConstants.ATT_NAME);
    }
    ...
    public String getRawParentPath() {
        return configurationElement == null ? null
                : configurationElement.getAttribute(IDataModelerUIRegistryConstants.ATT_PARENT_CATEGORY);
    }
