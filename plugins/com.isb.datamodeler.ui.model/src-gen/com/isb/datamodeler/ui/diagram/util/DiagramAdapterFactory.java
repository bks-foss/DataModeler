 ...
 * </copyright>
 *
 * $Id: DiagramAdapterFactory.java,v 1.4 2011/11/10 14:27:37 aalvamat Exp $
 */
...
public class DiagramAdapterFactory extends AdapterFactoryImpl {
	...
	protected DiagramSwitch<Adapter> modelSwitch =
		new DiagramSwitch<Adapter>() {
			@Override
			public Adapter caseDMDiagram(EDMDiagram object) {
				return createDMDiagramAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.isb.datamodeler.ui.diagram.EDMDiagram <em>DM Diagram</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createDMDiagramAdapter() {
		return null;
	}
