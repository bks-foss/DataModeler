 ...
 * </copyright>
 *
 * $Id: DMDiagramItemProvider.java,v 1.2 2012/06/05 11:09:43 aalvamat Exp $
 */
package com.isb.datamodeler.ui.diagram.provider;
...
/**
 * This is the item provider adapter for a {@link com.isb.datamodeler.ui.diagram.EDMDiagram} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DMDiagramItemProvider
	 ...
	 * @generated
	 */
	public DMDiagramItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DMDiagram"));
	}
	...
	public String getText(Object object) {
		String label = ((EDMDiagram)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_DMDiagram_type") :
			label;
	}
	...
	public ResourceLocator getResourceLocator() {
		return DatamodelerUIEditPlugin.INSTANCE;
	}
